    ...
    <div className="min-h-screen bg-procurvv-bg">
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center space-x-3 bg-white rounded-lg px-6 py-3 border border-procurvv-border">
              <svg className="w-5 h-5 text-procurvv-text" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-procurvv-text font-medium">2,847 stars on GitHub</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 shadow-sm border border-procurvv-border"
              >
                {/* Stars */}
                ...
                {/* Quote */}
                <blockquote className="text-procurvv-text mb-6 leading-relaxed">
                  "{testimonial.quote}"
                </blockquote>
